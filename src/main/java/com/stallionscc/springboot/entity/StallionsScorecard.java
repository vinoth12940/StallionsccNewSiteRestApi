...
@Entity
@Table(name = "StallionsScorecard")
public class StallionsScorecard {
	...
	public int getIs_rested() {
		return is_rested;
	}

	public void setIs_rested(int is_rested) {
		this.is_rested = is_rested;
	}
	...
	public String toString() {
		return "StallionsScorecard [score_card_id=" + score_card_id + ", tournament_id=" + tournament_id
				+ ", playersSk=" + playersSk + ", match_id=" + match_id + ", player_name=" + player_name
				+ ", player_role=" + player_role + ", is_rested=" + is_rested + ", comments=" + comments
